unit unit_UBER_H3_V4_API_ALL_version_007;
...
This unit is the bigger conversion of the UBER H3 VERSION 4 API.

It includes most (if not all) API functions found in the H3_V4.DLL.
...
const
{$IF Defined(WIN64)}
	// Comment from Skybuck Flying on 29 august 2022:
...
procedure setGeoDegs(p: PLatLng; latDegs: Double; lngDegs: Double); cdecl; external UBER_H3_V4 name _PU + 'setGeoDegs';
function constrainLat(lat: Double): Double; cdecl; external UBER_H3_V4 name _PU + 'constrainLat';
function constrainLng(lng: Double): Double; cdecl; external UBER_H3_V4 name _PU + 'constrainLng';
function geoAlmostEqual(const p1: PLatLng; const p2: PLatLng): Boolean; cdecl; external UBER_H3_V4 name _PU + 'geoAlmostEqual';
function geoAlmostEqualThreshold(const p1: PLatLng; const p2: PLatLng; threshold: Double): Boolean; cdecl; external UBER_H3_V4 name _PU + 'geoAlmostEqualThreshold';
function _posAngleRads(rads: Double): Double; cdecl; external UBER_H3_V4 name _PU + '_posAngleRads';
procedure _setGeoRads(p: PLatLng; latRads: Double; lngRads: Double); cdecl; external UBER_H3_V4 name _PU + '_setGeoRads';
function _geoAzimuthRads(const p1: PLatLng; const p2: PLatLng): Double; cdecl; external UBER_H3_V4 name _PU + '_geoAzimuthRads';
procedure _geoAzDistanceRads(const p1: PLatLng; az: Double; distance: Double; p2: PLatLng); cdecl; external UBER_H3_V4 name _PU + '_geoAzDistanceRads';
function bboxIsTransmeridian(const BBox: PBBox): Boolean; cdecl; external UBER_H3_V4 name _PU + 'bboxIsTransmeridian';
procedure bboxCenter(const BBox: PBBox; center: PLatLng); cdecl; external UBER_H3_V4 name _PU + 'bboxCenter';
function bboxContains(const BBox: PBBox; const point: PLatLng): Boolean; cdecl; external UBER_H3_V4 name _PU + 'bboxContains';
function bboxEquals(const b1: PBBox; const b2: PBBox): Boolean; cdecl; external UBER_H3_V4 name _PU + 'bboxEquals';
function bboxHexEstimate(const BBox: PBBox; res: Integer; &out: PInt64): H3Error; cdecl; external UBER_H3_V4 name _PU + 'bboxHexEstimate';
function lineHexEstimate(const origin: PLatLng; const destination: PLatLng; res: Integer; &out: PInt64): H3Error; cdecl; external UBER_H3_V4 name _PU + 'lineHexEstimate';
function _v2dMag(const v: PVec2d): Double; cdecl; external UBER_H3_V4 name _PU + '_v2dMag';
procedure _v2dIntersect(const p0: PVec2d; const p1: PVec2d; const p2: PVec2d; const p3: PVec2d; inter: PVec2d); cdecl; external UBER_H3_V4 name _PU + '_v2dIntersect';
function _v2dEquals(const p0: PVec2d; const p1: PVec2d): Boolean; cdecl; external UBER_H3_V4 name _PU + '_v2dEquals';
procedure _setIJK(ijk: PCoordIJK; i: Integer; j: Integer; k: Integer); cdecl; external UBER_H3_V4 name _PU + '_setIJK';
procedure _hex2dToCoordIJK(const v: PVec2d; h: PCoordIJK); cdecl; external UBER_H3_V4 name _PU + '_hex2dToCoordIJK';
procedure _ijkToHex2d(const h: PCoordIJK; v: PVec2d); cdecl; external UBER_H3_V4 name _PU + '_ijkToHex2d';
function _ijkMatches(const c1: PCoordIJK; const c2: PCoordIJK): Integer; cdecl; external UBER_H3_V4 name _PU + '_ijkMatches';
procedure _ijkAdd(const h1: PCoordIJK; const h2: PCoordIJK; sum: PCoordIJK); cdecl; external UBER_H3_V4 name _PU + '_ijkAdd';
procedure _ijkSub(const h1: PCoordIJK; const h2: PCoordIJK; diff: PCoordIJK); cdecl; external UBER_H3_V4 name _PU + '_ijkSub';
procedure _ijkScale(c: PCoordIJK; factor: Integer); cdecl; external UBER_H3_V4 name _PU + '_ijkScale';
procedure _ijkNormalize(c: PCoordIJK); cdecl; external UBER_H3_V4 name _PU + '_ijkNormalize';
function _unitIjkToDigit(const ijk: PCoordIJK): Direction; cdecl; external UBER_H3_V4 name _PU + '_unitIjkToDigit';
procedure _upAp7(ijk: PCoordIJK); cdecl; external UBER_H3_V4 name _PU + '_upAp7';
procedure _upAp7r(ijk: PCoordIJK); cdecl; external UBER_H3_V4 name _PU + '_upAp7r';
procedure _downAp7(ijk: PCoordIJK); cdecl; external UBER_H3_V4 name _PU + '_downAp7';
procedure _downAp7r(ijk: PCoordIJK); cdecl; external UBER_H3_V4 name _PU + '_downAp7r';
procedure _downAp3(ijk: PCoordIJK); cdecl; external UBER_H3_V4 name _PU + '_downAp3';
procedure _downAp3r(ijk: PCoordIJK); cdecl; external UBER_H3_V4 name _PU + '_downAp3r';
procedure _neighbor(ijk: PCoordIJK; digit: Direction); cdecl; external UBER_H3_V4 name _PU + '_neighbor';
procedure _ijkRotate60ccw(ijk: PCoordIJK); cdecl; external UBER_H3_V4 name _PU + '_ijkRotate60ccw';
procedure _ijkRotate60cw(ijk: PCoordIJK); cdecl; external UBER_H3_V4 name _PU + '_ijkRotate60cw';
function _rotate60ccw(digit: Direction): Direction; cdecl; external UBER_H3_V4 name _PU + '_rotate60ccw';
function _rotate60cw(digit: Direction): Direction; cdecl; external UBER_H3_V4 name _PU + '_rotate60cw';
function ijkDistance(const a: PCoordIJK; const b: PCoordIJK): Integer; cdecl; external UBER_H3_V4 name _PU + 'ijkDistance';
procedure ijkToIj(const ijk: PCoordIJK; IJ: PCoordIJ); cdecl; external UBER_H3_V4 name _PU + 'ijkToIj';
procedure ijToIjk(const IJ: PCoordIJ; ijk: PCoordIJK); cdecl; external UBER_H3_V4 name _PU + 'ijToIjk';
procedure ijkToCube(ijk: PCoordIJK); cdecl; external UBER_H3_V4 name _PU + 'ijkToCube';
procedure cubeToIjk(ijk: PCoordIJK); cdecl; external UBER_H3_V4 name _PU + 'cubeToIjk';
function normalizeMultiPolygon(root: PLinkedGeoPolygon): Integer; cdecl; external UBER_H3_V4 name _PU + 'normalizeMultiPolygon';
function addNewLinkedPolygon(polygon: PLinkedGeoPolygon): PLinkedGeoPolygon; cdecl; external UBER_H3_V4 name _PU + 'addNewLinkedPolygon';
function addNewLinkedLoop(polygon: PLinkedGeoPolygon): PLinkedGeoLoop; cdecl; external UBER_H3_V4 name _PU + 'addNewLinkedLoop';
function addLinkedLoop(polygon: PLinkedGeoPolygon; loop: PLinkedGeoLoop): PLinkedGeoLoop; cdecl; external UBER_H3_V4 name _PU + 'addLinkedLoop';
function addLinkedCoord(loop: PLinkedGeoLoop; const vertex: PLatLng): PLinkedLatLng; cdecl; external UBER_H3_V4 name _PU + 'addLinkedCoord';
function countLinkedPolygons(polygon: PLinkedGeoPolygon): Integer; cdecl; external UBER_H3_V4 name _PU + 'countLinkedPolygons';
function countLinkedLoops(polygon: PLinkedGeoPolygon): Integer; cdecl; external UBER_H3_V4 name _PU + 'countLinkedLoops';
function countLinkedCoords(loop: PLinkedGeoLoop): Integer; cdecl; external UBER_H3_V4 name _PU + 'countLinkedCoords';

procedure destroyLinkedGeoLoop(loop: PLinkedGeoLoop); cdecl; external UBER_H3_V4 name _PU + 'destroyLinkedGeoLoop';
...
*)
procedure bboxFromLinkedGeoLoop(const loop: PLinkedGeoLoop; BBox: PBBox); cdecl; external UBER_H3_V4 name _PU + 'bboxFromLinkedGeoLoop';
...
*)
function pointInsideLinkedGeoLoop(const loop: PLinkedGeoLoop; const BBox: PBBox; const coord: PLatLng): Boolean; cdecl; external UBER_H3_V4 name _PU + 'pointInsideLinkedGeoLoop';
...
*)
function isClockwiseLinkedGeoLoop(const loop: PLinkedGeoLoop): Boolean; cdecl; external UBER_H3_V4 name _PU + 'isClockwiseLinkedGeoLoop';
procedure initVertexGraph(graph: PVertexGraph; numBuckets: Integer; res: Integer); cdecl; external UBER_H3_V4 name _PU + 'initVertexGraph';
procedure destroyVertexGraph(graph: PVertexGraph); cdecl; external UBER_H3_V4 name _PU + 'destroyVertexGraph';
function addVertexNode(graph: PVertexGraph; const fromVtx: PLatLng; const toVtx: PLatLng): PVertexNode; cdecl; external UBER_H3_V4 name _PU + 'addVertexNode';
function removeVertexNode(graph: PVertexGraph; node: PVertexNode): Integer; cdecl; external UBER_H3_V4 name _PU + 'removeVertexNode';
function findNodeForEdge(const graph: PVertexGraph; const fromVtx: PLatLng; const toVtx: PLatLng): PVertexNode; cdecl; external UBER_H3_V4 name _PU + 'findNodeForEdge';
function findNodeForVertex(const graph: PVertexGraph; const fromVtx: PLatLng): PVertexNode; cdecl; external UBER_H3_V4 name _PU + 'findNodeForVertex';
function firstVertexNode(const graph: PVertexGraph): PVertexNode; cdecl; external UBER_H3_V4 name _PU + 'firstVertexNode';
function _hashVertex(const vertex: PLatLng; res: Integer; numBuckets: Integer): UInt32; cdecl; external UBER_H3_V4 name _PU + '_hashVertex';
procedure _initVertexNode(node: PVertexNode; const fromVtx: PLatLng; const toVtx: PLatLng); cdecl; external UBER_H3_V4 name _PU + '_initVertexNode';
function h3NeighborRotations(origin: H3Index; dir: Direction; rotations: PInteger; &out: PH3Index): H3Error; cdecl; external UBER_H3_V4 name _PU + 'h3NeighborRotations';
function directionForNeighbor(origin: H3Index; destination: H3Index): Direction; cdecl; external UBER_H3_V4 name _PU + 'directionForNeighbor';
procedure _kRingInternal(origin: H3Index; k: Integer; &out: PH3Index; distances: PInteger; maxIdx: Integer; curK: Integer); cdecl; external UBER_H3_V4 name _PU + '_kRingInternal';
function h3SetToVertexGraph(const h3Set: PH3Index; const numHexes: Integer; &out: PVertexGraph): H3Error; cdecl; external UBER_H3_V4 name _PU + 'h3SetToVertexGraph';
procedure _vertexGraphToLinkedGeo(graph: PVertexGraph; &out: PLinkedGeoPolygon); cdecl; external UBER_H3_V4 name _PU + '_vertexGraphToLinkedGeo';
function _getEdgeHexagons(const GeoLoop: PGeoLoop; numHexagons: Int64; res: Integer; numSearchHexes: PInt64; search: PH3Index; found: PH3Index): H3Error; cdecl; external UBER_H3_V4 name _PU + '_getEdgeHexagons';
function _gridDiskDistancesInternal(origin: H3Index; k: Integer; &out: PH3Index; distances: PInteger; maxIdx: Int64; curK: Integer): H3Error; cdecl; external UBER_H3_V4 name _PU + '_gridDiskDistancesInternal';
procedure _geoToFaceIjk(const g: PLatLng; res: Integer; h: PFaceIJK); cdecl; external UBER_H3_V4 name _PU + '_geoToFaceIjk';
procedure _geoToHex2d(const g: PLatLng; res: Integer; face: PInteger; v: PVec2d); cdecl; external UBER_H3_V4 name _PU + '_geoToHex2d';
procedure _faceIjkToGeo(const h: PFaceIJK; res: Integer; g: PLatLng); cdecl; external UBER_H3_V4 name _PU + '_faceIjkToGeo';
procedure _faceIjkToCellBoundary(const h: PFaceIJK; res: Integer; start: Integer; length: Integer; g: PCellBoundary); cdecl; external UBER_H3_V4 name _PU + '_faceIjkToCellBoundary';
procedure _faceIjkPentToCellBoundary(const h: PFaceIJK; res: Integer; start: Integer; length: Integer; g: PCellBoundary); cdecl; external UBER_H3_V4 name _PU + '_faceIjkPentToCellBoundary';
procedure _faceIjkToVerts(fijk: PFaceIJK; res: PInteger; fijkVerts: PFaceIJK); cdecl; external UBER_H3_V4 name _PU + '_faceIjkToVerts';
procedure _faceIjkPentToVerts(fijk: PFaceIJK; res: PInteger; fijkVerts: PFaceIJK); cdecl; external UBER_H3_V4 name _PU + '_faceIjkPentToVerts';
procedure _hex2dToGeo(const v: PVec2d; face: Integer; res: Integer; substrate: Integer; g: PLatLng); cdecl; external UBER_H3_V4 name _PU + '_hex2dToGeo';
function _adjustOverageClassII(fijk: PFaceIJK; res: Integer; pentLeading4: Integer; substrate: Integer): Overage; cdecl; external UBER_H3_V4 name _PU + '_adjustOverageClassII';
function _adjustPentVertOverage(fijk: PFaceIJK; res: Integer): Overage; cdecl; external UBER_H3_V4 name _PU + '_adjustPentVertOverage';
procedure _geoToClosestFace(const g: PLatLng; face: PInteger; sqd: PDouble); cdecl; external UBER_H3_V4 name _PU + '_geoToClosestFace';
function _isBaseCellPentagon(baseCell: Integer): Integer; cdecl; external UBER_H3_V4 name _PU + '_isBaseCellPentagon';
function _isBaseCellPolarPentagon(baseCell: Integer): Boolean; cdecl; external UBER_H3_V4 name _PU + '_isBaseCellPolarPentagon';
function _faceIjkToBaseCell(const h: PFaceIJK): Integer; cdecl; external UBER_H3_V4 name _PU + '_faceIjkToBaseCell';
function _faceIjkToBaseCellCCWrot60(const h: PFaceIJK): Integer; cdecl; external UBER_H3_V4 name _PU + '_faceIjkToBaseCellCCWrot60';
function _baseCellToCCWrot60(baseCell: Integer; face: Integer): Integer; cdecl; external UBER_H3_V4 name _PU + '_baseCellToCCWrot60';
procedure _baseCellToFaceIjk(baseCell: Integer; h: PFaceIJK); cdecl; external UBER_H3_V4 name _PU + '_baseCellToFaceIjk';
function _baseCellIsCwOffset(baseCell: Integer; testFace: Integer): Boolean; cdecl; external UBER_H3_V4 name _PU + '_baseCellIsCwOffset';
function _getBaseCellNeighbor(baseCell: Integer; dir: Direction): Integer; cdecl; external UBER_H3_V4 name _PU + '_getBaseCellNeighbor';
function _getBaseCellDirection(originBaseCell: Integer; destinationBaseCell: Integer): Direction; cdecl; external UBER_H3_V4 name _PU + '_getBaseCellDirection';
procedure setH3Index(h: PH3Index; res: Integer; baseCell: Integer; initDigit: Direction); cdecl; external UBER_H3_V4 name _PU + 'setH3Index';
function isResolutionClassIII(r: Integer): Integer; cdecl; external UBER_H3_V4 name _PU + 'isResolutionClassIII';
function _h3ToFaceIjkWithInitializedFijk(h: H3Index; fijk: PFaceIJK): Integer; cdecl; external UBER_H3_V4 name _PU + '_h3ToFaceIjkWithInitializedFijk';
function _h3ToFaceIjk(h: H3Index; fijk: PFaceIJK): H3Error; cdecl; external UBER_H3_V4 name _PU + '_h3ToFaceIjk';
function _faceIjkToH3(const fijk: PFaceIJK; res: Integer): H3Index; cdecl; external UBER_H3_V4 name _PU + '_faceIjkToH3';
function _h3LeadingNonZeroDigit(h: H3Index): Direction; cdecl; external UBER_H3_V4 name _PU + '_h3LeadingNonZeroDigit';
function _h3RotatePent60ccw(h: H3Index): H3Index; cdecl; external UBER_H3_V4 name _PU + '_h3RotatePent60ccw';
function _h3RotatePent60cw(h: H3Index): H3Index; cdecl; external UBER_H3_V4 name _PU + '_h3RotatePent60cw';
function _h3Rotate60ccw(h: H3Index): H3Index; cdecl; external UBER_H3_V4 name _PU + '_h3Rotate60ccw';
function _h3Rotate60cw(h: H3Index): H3Index; cdecl; external UBER_H3_V4 name _PU + '_h3Rotate60cw';
function _zeroIndexDigits(h: H3Index; start: Integer; &end: Integer): H3Index; cdecl; external UBER_H3_V4 name _PU + '_zeroIndexDigits';
function iterInitParent(h: H3Index; childRes: Integer): IterCellsChildren; cdecl; external UBER_H3_V4 name _PU + 'iterInitParent';
function iterInitBaseCellNum(baseCellNum: Integer; childRes: Integer): IterCellsChildren; cdecl; external UBER_H3_V4 name _PU + 'iterInitBaseCellNum';
procedure iterStepChild(iter: PIterCellsChildren); cdecl; external UBER_H3_V4 name _PU + 'iterStepChild';
function iterInitRes(res: Integer): IterCellsResolution; cdecl; external UBER_H3_V4 name _PU + 'iterInitRes';
procedure iterStepRes(iter: PIterCellsResolution); cdecl; external UBER_H3_V4 name _PU + 'iterStepRes';
function cellToLocalIjk(origin: H3Index; h3: H3Index; &out: PCoordIJK): H3Error; cdecl; external UBER_H3_V4 name _PU + 'cellToLocalIjk';
function localIjkToCell(origin: H3Index; const ijk: PCoordIJK; &out: PH3Index): H3Error; cdecl; external UBER_H3_V4 name _PU + 'localIjkToCell';
function _ipow(base: Int64; exp: Int64): Int64; cdecl; external UBER_H3_V4 name _PU + '_ipow';
procedure bboxesFromGeoPolygon(const polygon: PGeoPolygon; bboxes: PBBox); cdecl; external UBER_H3_V4 name _PU + 'bboxesFromGeoPolygon';
function pointInsidePolygon(const GeoPolygon: PGeoPolygon; const bboxes: PBBox; const coord: PLatLng): Boolean; cdecl; external UBER_H3_V4 name _PU + 'pointInsidePolygon';
...
(* *
  ...
  * @param bbox     Output bbox
*)
procedure bboxFromGeoLoop(const loop: PGeoLoop; BBox: PBBox); cdecl; external UBER_H3_V4 name _PU + 'bboxFromGeoLoop';
...
(* *
  ...
  * @return              Whether the point is contained
*)
function pointInsideGeoLoop(const loop: PGeoLoop; const BBox: PBBox; const coord: PLatLng): Boolean; cdecl; external UBER_H3_V4 name _PU + 'pointInsideGeoLoop';
...
(* *
  ...
  * @return      Whether the loop is clockwise
*)
function isClockwiseGeoLoop(const GeoLoop: PGeoLoop): Boolean; cdecl; external UBER_H3_V4 name _PU + 'isClockwiseGeoLoop';
procedure _geoToVec3d(const geo: PLatLng; point: PVec3d); cdecl; external UBER_H3_V4 name _PU + '_geoToVec3d';
function _pointSquareDist(const p1: PVec3d; const p2: PVec3d): Double; cdecl; external UBER_H3_V4 name _PU + '_pointSquareDist';
function vertexNumForDirection(const origin: H3Index; const Direction: Direction): Integer; cdecl; external UBER_H3_V4 name _PU + 'vertexNumForDirection';
function directionForVertexNum(const origin: H3Index; const vertexNum: Integer): Direction; cdecl; external UBER_H3_V4 name _PU + 'directionForVertexNum';
